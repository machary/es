...
function optionsframework_options() {
	...
	$options_scategory = array();
	$options_scategory_obj = get_terms('slider-category');
	if($options_scategory_obj){
		foreach ($options_scategory_obj as $scategory) {
			$options_scategory[$scategory->slug] = $scategory->name;
		}
	}
	...
	$options[] = array( 'name' => __('Tracking Code', 'klasik'),
		'desc' => __('Enter your tracking code here.', 'klasik'),
